...
def main():
    ...
    fake_sessions = {
        ...
        "fake_submission_002": make_session([
            ...
            {"Time (seconds)": 12, "Button": "Play", "Program": "forward forward"},
            {"Time (seconds)": 14, "Button": "Right"},
            {"Time (seconds)": 20, "Button": "Play", "Program": "forward forward right"},
            {"Time (seconds)": 24, "Button": "Reverse"},
            {"Time (seconds)": 28, "Button": "Test", "Program": "forward forward right reverse"},
            {"Time (seconds)": 30, "Button": "Play", "Program": "Empty"},
