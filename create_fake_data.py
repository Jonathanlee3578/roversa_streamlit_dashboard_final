...
def main():
    ...
    fake_sessions = {
        "fake_submission_001": make_session([
            ...
            {"Time (seconds)": 10, "Button": "Play", "Program": "forward"},
            {"Time (seconds)": 18, "Button": "Left"},
            {"Time (seconds)": 22, "Button": "Play", "Program": "forward left"},
            {"Time (seconds)": 35, "Session": "NEW", "Battery": 4.24},
            {"Time (seconds)": 40, "Button": "Forward"},
            {"Time (seconds)": 45, "Button": "Right"},
            {"Time (seconds)": 52, "Button": "Play", "Program": "forward right forward"},
        ...
        "fake_submission_002": make_session([
            ...
            {"Time (seconds)": 12, "Button": "Left"},
            {"Time (seconds)": 20, "Button": "Play", "Program": "forward forward left"},
            {"Time (seconds)": 32, "Button": "Clear"},
            {"Time (seconds)": 45, "Button": "Forward"},
            {"Time (seconds)": 50, "Button": "Forward"},
            {"Time (seconds)": 55, "Button": "Forward"},
            {"Time (seconds)": 60, "Button": "Left"},
            {"Time (seconds)": 70, "Button": "Play", "Program": "forward forward forward left"},
            {"Time (seconds)": 95, "Button": "Test", "Program": "forward forward forward left"},
        ]),
